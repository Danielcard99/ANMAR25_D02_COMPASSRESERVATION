import { BadRequestException, Get, Injectable, InternalServerErrorException, NotFoundException, Query } from '@nestjs/common';
...
export class UserService {
  ...
  async update(id: number, {name, email, telephone, password}: UpdatePatchDTO) {
